<template>
  <div class="space-y-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      <div class="p-6">
        <div v-for="activity in recentActivities" :key="activity.id" class="flex items-start space-x-4 mb-4 last:mb-0">
...
const recentActivities = ref([
  {
    ...
    avatar:
      'https://readdy.ai/api/search-image?query=professional%20woman%20business%20portrait%20headshot%20clean%20background%20modern%20corporate%20style&width=32&height=32&seq=activity-user-001&orientation=squarish'
  },
  {
    id: 2,
    user: 'Mike Chen',
    ...
    avatar:
      'https://readdy.ai/api/search-image?query=professional%20man%20business%20portrait%20headshot%20clean%20background%20modern%20corporate%20style&width=32&height=32&seq=activity-user-002&orientation=squarish'
  },
  {
    id: 3,
    user: 'Emma Davis',
    ...
    statusColor: 'bg-green-100 text-green-800',
    avatar:
      'https://readdy.ai/api/search-image?query=professional%20woman%20business%20portrait%20headshot%20clean%20background%20modern%20corporate%20style&width=32&height=32&seq=activity-user-003&orientation=squarish'
  }
])
